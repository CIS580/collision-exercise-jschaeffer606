...
namespace CollisionExample.Collisions
{
    public static class CollisionHelper
    {
        ...
        /// <returns>true fo collision, false otherwise</returns>
        ...
        /// </summary>
        /// <param name="a">The frist rectangle</param>
        /// <param name="b">The second rectangle</param>
        /// <returns>true for collision, false for everything else</returns>
        ...
        /// <summary>
        /// Detects a collision between a rectangle and ac ircle
        /// </summary>
        ...
        public static bool Collides(BoundingCircle c, BoundingRectangle r)
        {
            ...
            return Math.Pow(c.Radius, 2) >=
                Math.Pow(c.Center.X - nearestX, 2) + Math.Pow(c.Center.Y - nearestY, 2);
        }
